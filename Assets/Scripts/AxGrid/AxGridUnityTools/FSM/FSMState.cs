...
public class LogWrapper : AxGrid.ILog
{
    ...
    public void Fatal(string msg) => _inner.Fatal(msg);
}
...
namespace AxGrid.FSM
{
    ...
    public abstract class FSMState : IState
    {
        ...
        private AxGrid.ILog Log
        {
            get
            {
                if (_log == null)
                    _log = new LogWrapper(log4net.LogManager.GetLogger(GetType().Name));
                return _log;
            }
        }
        ...
        private class TimingObject {
            ...
            private static readonly AxGrid.ILog Log = new LogWrapper(log4net.LogManager.GetLogger("TimingObject"));
